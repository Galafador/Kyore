...
class Listing(models.Model):
    ...
    starting_bid = models.DecimalField(max_digits=16, decimal_places=2, default=0.00, validators=[MinValueValidator(0)])
    has_bids = models.BooleanField(default=False)
    highest_bid = models.DecimalField(max_digits=16, decimal_places=2, default=0.00, validators=[MinValueValidator(0)])
